...
2. Thay Go patterns → Python/FastAPI patterns
3. Sửa `templates/` cho Python

### Vue.js Frontend
1. Sửa `prompts/specialists/frontend.md`
2. Thay React patterns → Vue patterns
3. Sửa `templates/next_component_skeleton.md`
