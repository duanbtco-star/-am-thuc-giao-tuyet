...
code_quality:
  go_tests:
    command: "go test ./internal/modules/{module}/... -v -cover"
    success_criteria:
      - exit_code: 0
      - coverage: ">= 70%"
    error_code: E300
...
rls_verification:
  ...
  tenant_isolation_test:
    command: "go test -tags=rls ./internal/modules/{module}/..."
    success_criteria:
      - exit_code: 0
    error_code: E100
```
...
permission_verification:
  ...
  frontend_enforced:
    check: file_contains
    paths: "src/app/(dashboard)/{module}/**/*.tsx"
    pattern: "usePermission|can\\("
    error_code: E301
    
  backend_enforced:
    check: file_contains
    paths: "internal/modules/{module}/**/*.go"
    pattern: "RequirePermission|Authorize"
    error_code: E301
```
...
i18n_verification:
  vi_translations:
    check: file_contains
    path: "src/locales/vi/{module}.json"
    pattern: "{feature}"
    error_code: E401
    
  en_translations:
    check: file_contains
    path: "src/locales/en/{module}.json"
    pattern: "{feature}"
    error_code: E401
